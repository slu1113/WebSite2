...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataKeyNames="DeviceUid" DataSourceID="LinqDataSource3" RenderOuterTable="False" OnPageIndexChanging="FormView1_PageIndexChanging">
        <EditItemTemplate>
            DeviceUid:
        ...
        <ItemTemplate>
            ...
            <br />
            <asp:LinkButton ID="EditButton"  class="btn btn-primary btn-lg" runat="server" CausesValidation="False" CommandName="Edit" Text="編輯" />
            &nbsp;<asp:LinkButton class="btn btn-primary btn-lg"  ID="DeleteButton" runat="server" CausesValidation="False" CommandName="Delete" Text="刪除" />
            &nbsp;<asp:LinkButton class="btn btn-primary btn-lg" ID="NewButton" runat="server" CausesValidation="False" CommandName="New" Text="新增" />
        </ItemTemplate>
